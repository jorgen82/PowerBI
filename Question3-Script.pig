...
values = FOREACH grouped_countries GENERATE group AS country, AVG(data.cpi_country) as cpi_country, SUM(data.finalWorth) AS total_worth, COUNT(data.finalWorth) AS billionaires_count;
